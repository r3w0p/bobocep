...
class TestValid:
    ...
    def test_handle_10_actions_3_processes(self):
        handler = BoboActionHandlerMultithreading(threads=3, max_size=255)
    ...
    def test_handle_10_actions_10_processes(self):
        handler = BoboActionHandlerMultithreading(threads=10, max_size=255)
...
class TestInvalid:
    ...
    def test_add_action_event_queue_full(self):
        handler = BoboActionHandlerMultithreading(threads=1, max_size=1)
